...
```{R art-year, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Article count by year"}
...
```{R kw-treemap, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Keyword treemap"}
