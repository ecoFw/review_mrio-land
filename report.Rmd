...
```{r loadd-data, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mrio-io, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mrio-land, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mrio-for, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mrio-ena, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mrio-res, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mrio-dist, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mrio-chns, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mrio-met, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r mrio-rev, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r papers-iomrio, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r papers-rev, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r papers-ena, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}

io.bdf[q.ena | q.ov, c("TI")]

```

```{r papers-net, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r papers-met, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}

io.bdf[q.met, c("TI")]

```

```{r papers-met-land, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r papers-res, eval = FALSE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r key-words, eval = FALSE, echo = TRUE, message = FALSE, warning = FALSE}
...
```{R art-year, eval = FALSE, echo=FALSE, message=FALSE, warning=FALSE, fig.cap=""}
...
```{R kw-treemap, eval = FALSE, echo=FALSE, message=FALSE, warning=FALSE, fig.cap=""}
...
```{r query-list, eval = FALSE, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r topic-table, eval = FALSE, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, results="asis"}
...
```{r export-query, eval = FALSE, echo = TRUE, message = FALSE, warning = FALSE}
...
## Coupled-Human-Natural Systems + MRIO

- LAND-USE CHANGES IN DISTANT PLACES: IMPLEMENTATION OF A TELECOUPLED
  AGENT-BASED MODEL | DOU Y, 2020, JASSS | ISI000510855400011
- ECO-CERTIFICATION PROTOCOLS AS MECHANISMS TO FOSTER SUSTAINABLE
  ENVIRONMENTAL PRACTICES IN TELECOUPLED SYSTEMS | BICUDO DA SILVA RF,
  2019, FOREST POLICY ECON | ISI000469866900006
- THE TELECOUPLING GEOAPP: A WEB-GIS APPLICATION TO SYSTEMATICALLY
  ANALYZE TELECOUPLINGS AND SUSTAINABLE DEVELOPMENT | MCCORD P, 2018,
  APPL GEOGR | ISI000436053300003
- THE SINO-BRAZILIAN TELECOUPLED SOYBEAN SYSTEM AND CASCADING EFFECTS
  FOR THE EXPORTING COUNTRY | BICUDO DA SILVA RF, 2017, LAND |
  ISI000411997300009
- EVEN AT THE UTTERMOST ENDS OF THE EARTH: HOW SEABIRDS TELECOUPLE THE
  BEAGLE CHANNEL WITH REGIONAL AND GLOBAL PROCESSES THAT AFFECT
  ENVIRONMENTAL CONSERVATION AND SOCIAL-ECOLOGICAL SUSTAINABILITY |
  RAYA REY AN, 2017, ECOL SOC | ISI000419351000035
- TELECOUPLING TOOLBOX: SPATIALLY EXPLICIT TOOLS FOR STUDYING
  TELECOUPLED HUMAN AND NATURAL SYSTEMS | TONINI F, 2017, ECOL SOC |
  ISI000419351000022
- EVOLVING HUMAN LANDSCAPES: A VIRTUAL LABORATORY APPROACH | MAGLIOCCA
  NR, 2016, J LAND USE SCI | ISI000399047700003
- ENVIRONMENTAL SUSTAINABILITY AS THE FIRST PRINCIPLE OF DISTRIBUTIVE
  JUSTICE: TOWARDS AN ECOLOGICAL COMMUNITARIAN NORMATIVE FOUNDATION
  FOR ECOLOGICAL ECONOMICS | PELLETIER N, 2010, ECOL ECON |
  ISI000280656900001
